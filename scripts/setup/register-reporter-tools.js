...
const log = createLogger('register-reporter-tools');
...
// Reporter-specific tool files
const ESQL_TOOLS = [
  'vigil-report-executive-summary.json',
  'vigil-report-compliance-evidence.json',
  'vigil-report-operational-trends.json',
  'vigil-report-agent-performance.json',
  'vigil-report-incident-detail-export.json'
];

const SEARCH_TOOLS = [
  'vigil-search-incidents-for-report.json'
];
